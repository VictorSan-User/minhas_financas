...
@section('content')
    ...
    <div class="card-dark shadow text-dark">
        <div class="card-body">
            <h2 class="text-center mb-4" style="color: #0d6efd;">Novo Plano</h2>
            <p class="text-center text-secondary mb-4">Insira os detalhes para sua seu novo Plano.</p>

            <form action="{{ route('ideia.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label for="title" class="form-label text-primary"><strong>Título</strong></label>
                    <input type="text" class="form-control form-control-lg form-control" id="titulo" name="titulo" placeholder="Novo agente de IA">
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label text-primary"><strong>Descrição da ideia</strong></label>
                    <textarea class="form-control form-control-lg form-control" id="description" name="description" rows="3" placeholder="Detalhes da ideia"></textarea>
                </div>
