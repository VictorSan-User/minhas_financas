        ...
        <div class="container my-5">
            <div class="card border-danger shadow-lg" style="max-width: 25rem; margin: auto;">
                <div class="card-header bg-danger">
                    <h5 class="mb-0">
                        <i class="bi bi-exclamation-triangle-fill me-2 text-light"></i> Aviso de Confirmação
                    </h5>
                </div>
                <div class="card-body text-center">
                    <h4 class="card-title text-danger">Tem certeza que deseja cancelar o registro {{ $id }}?</h4>
                    <p class="card-text">
                ...
                <div class="card-footer d-flex justify-content-between">
                    <button type="submit" class="btn btn-danger btn-sm w-50 me-2 text-white">
                            <i class="bi bi-x-circle-fill me-1"></i> Sim, Cancelar
                    </button>
